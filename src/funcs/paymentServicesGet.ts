 ...
 */
export function paymentServicesGet(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.GetPaymentServiceResponse403GetPaymentService
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const pathParams = {
    payment_service_id: encodeSimple(
      "payment_service_id",
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.PaymentService$inboundSchema),
    M.jsonErr(400, errors.Error400$inboundSchema),
    M.jsonErr(401, errors.Error401$inboundSchema),
    M.jsonErr(
      403,
      errors.GetPaymentServiceResponse403GetPaymentService$inboundSchema,
    ),
