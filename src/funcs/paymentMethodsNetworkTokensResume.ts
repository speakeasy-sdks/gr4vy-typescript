 ...
 */
export function paymentMethodsNetworkTokensResume(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.ResumePaymentMethodNetworkTokenResponse403ResumePaymentMethodNetworkToken
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ResumePaymentMethodNetworkTokenRequest$outboundSchema.parse(
        value,
      ),
