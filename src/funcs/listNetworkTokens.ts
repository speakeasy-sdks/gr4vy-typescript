 ...
 * Network Tokens
 */
export async function listNetworkTokens(
    client$: Gr4vyCore,
    ...
    >
> {
    const input$: operations.ListNetworkTokensRequest = {
        paymentMethodId: paymentMethodId,
    };

    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ListNetworkTokensRequest$outboundSchema.parse(value$),
    ...
    const context = {
        operationID: "list_network_tokens",
        oAuth2Scopes: [],
