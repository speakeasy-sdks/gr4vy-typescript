 ...
 */
export async function listCardFlowActionRule3dsOutcomes(
    client$: Gr4vyCore,
    ...
    >
> {
    const path$ = pathToFunc("/flows/card-transaction/actions/skip-3ds/outcomes")();
    ...
    const context = {
        operationID: "list_card_flow_action_rule_3ds_outcomes",
        oAuth2Scopes: [],
