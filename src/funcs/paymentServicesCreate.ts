...
export function paymentServicesCreate(
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.UpdatePaymentServiceResponse403UpdatePaymentService
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.PaymentService$inboundSchema),
    M.jsonErr(400, errors.Error400$inboundSchema),
    M.jsonErr(401, errors.Error401$inboundSchema),
    M.jsonErr(
      403,
      errors.UpdatePaymentServiceResponse403UpdatePaymentService$inboundSchema,
    ),
