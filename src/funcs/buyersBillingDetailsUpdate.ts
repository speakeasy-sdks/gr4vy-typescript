...
export async function buyersBillingDetailsUpdate(
    ...
    Result<
        components.BillingDetailsSummary,
...
> {
    ...
    const body$ = encodeJSON$("body", payload$.BillingDetails, { explode: true });
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.BillingDetailsSummary$inboundSchema),
