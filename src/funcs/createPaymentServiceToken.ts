 ...
 * Tokenize
 */
export async function createPaymentServiceToken(
    client$: Gr4vyCore,
    ...
    >
> {
    const input$: operations.CreatePaymentServiceTokenRequest = {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.CreatePaymentServiceTokenRequest$outboundSchema.parse(value$),
    ...
    const body$ = encodeJSON$("body", payload$.PaymentServiceTokenCreate, { explode: true });
    ...
    const path$ = pathToFunc("/payment-methods/{payment_method_id}/payment-service-tokens")(
        pathParams$
    );
    ...
    const context = {
        operationID: "create_payment_service_token",
        oAuth2Scopes: [],
