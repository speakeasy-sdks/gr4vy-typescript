 ...
 */
export function paymentLinksGet(
  client: Gr4vyCore,
...
> {
  const input: operations.GetPaymentLinkRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.GetPaymentLinkRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/payment-links/{payment_link_id}")(pathParams);
