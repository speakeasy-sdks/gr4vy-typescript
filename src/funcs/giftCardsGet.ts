...
export function giftCardsGet(
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.GetGiftCardResponse403GetGiftCard
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const path = pathToFunc("/gift-cards/{gift_card_id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GiftCard$inboundSchema),
    M.jsonErr(400, errors.Error400$inboundSchema),
    M.jsonErr(401, errors.Error401$inboundSchema),
    M.jsonErr(403, errors.GetGiftCardResponse403GetGiftCard$inboundSchema),
