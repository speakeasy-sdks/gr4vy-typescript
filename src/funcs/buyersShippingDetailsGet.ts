 ...
 */
export function buyersShippingDetailsGet(
  client: Gr4vyCore,
  buyerId: string,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.GetBuyerShippingDetailsResponse403GetBuyerShippingDetails
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetBuyerShippingDetailsRequest$outboundSchema.parse(value),
