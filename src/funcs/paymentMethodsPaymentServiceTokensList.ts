...
export function paymentMethodsPaymentServiceTokensList(
  ...
  Result<
    components.PaymentServiceTokens,
    | errors.Error400
    | errors.Error401
    | errors.Error403
    | errors.Error404
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListPaymentMethodPaymentServiceTokensRequest$outboundSchema
        .parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.PaymentServiceTokens$inboundSchema),
