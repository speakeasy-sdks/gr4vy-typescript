 ...
 */
export function paymentServiceDefinitionsSession(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.CreatePaymentServiceDefinitionSessionResponse403CreatePaymentServiceDefinitionSession
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.CreatePaymentServiceDefinitionSessionRequest$outboundSchema
        .parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.CreateSession$inboundSchema),
