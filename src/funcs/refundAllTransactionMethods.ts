 ...
 * Refund All
 */
export async function refundAllTransactionMethods(
    client$: Gr4vyCore,
    ...
    >
> {
    const input$: operations.RefundAllTransactionMethodsRequest = {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.RefundAllTransactionMethodsRequest$outboundSchema.parse(value$),
    ...
    const body$ = encodeJSON$("body", payload$.TransactionRefundAllCreate, { explode: true });
    ...
    const context = {
        operationID: "refund_all_transaction_methods",
        oAuth2Scopes: [],
