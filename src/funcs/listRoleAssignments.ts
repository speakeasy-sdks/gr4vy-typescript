...
export async function listRoleAssignments(
    ...
    PageIterator<
        Result<
            operations.ListRoleAssignmentsResponse,
...
> {
    ...
    const path$ = pathToFunc("/roles/assignments")();
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ListRoleAssignmentsResponse$inboundSchema, { key: "Result" }),
