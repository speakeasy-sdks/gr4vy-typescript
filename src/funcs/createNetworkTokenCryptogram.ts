 ...
 * Issue Cryptogram
 */
export async function createNetworkTokenCryptogram(
    client$: Gr4vyCore,
    ...
    >
> {
    const input$: operations.CreateNetworkTokenCryptogramRequest = {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.CreateNetworkTokenCryptogramRequest$outboundSchema.parse(value$),
    ...
    const context = {
        operationID: "create_network_token_cryptogram",
        oAuth2Scopes: [],
