 ...
 */
export function digitalWalletsDomainsCreate(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.RegisterDigitalWalletDomainResponse403RegisterDigitalWalletDomain
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.RegisterDigitalWalletDomainRequest$outboundSchema.parse(value),
