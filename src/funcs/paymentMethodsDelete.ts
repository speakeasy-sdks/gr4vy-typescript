...
export function paymentMethodsDelete(
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.DeletePaymentMethodResponse403DeletePaymentMethod
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DeletePaymentMethodRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      403,
      errors.DeletePaymentMethodResponse403DeletePaymentMethod$inboundSchema,
    ),
