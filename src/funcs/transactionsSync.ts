...
export function transactionsSync(
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.SyncTransactionResponse403SyncTransaction
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  const input: operations.SyncTransactionRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.SyncTransactionRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      403,
      errors.SyncTransactionResponse403SyncTransaction$inboundSchema,
    ),
