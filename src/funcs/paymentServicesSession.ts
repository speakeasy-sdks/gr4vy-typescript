 ...
 */
export function paymentServicesSession(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.CreatePaymentServiceSessionResponse403CreatePaymentServiceSession
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.CreatePaymentServiceSessionRequest$outboundSchema.parse(value),
