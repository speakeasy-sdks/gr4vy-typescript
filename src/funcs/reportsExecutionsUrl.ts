 ...
 */
export function reportsExecutionsUrl(
  client: Gr4vyCore,
  reportId: string,
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.CreateReportExecutionUrlRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ReportExecutionUrl$inboundSchema),
