 ...
 * Delete
 */
export async function deleteAntiFraudService(
    client$: Gr4vyCore,
...
> {
    ...
    const path$ = pathToFunc("/anti-fraud-services/{anti_fraud_service_id}")(pathParams$);
    ...
    const context = {
        operationID: "delete_anti_fraud_service",
        oAuth2Scopes: [],
