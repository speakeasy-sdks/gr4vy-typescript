 ...
 */
export function paymentMethodsNetworkTokensList(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.ListPaymentMethodNetworkTokensResponse403ListPaymentMethodNetworkTokens
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  const input: operations.ListPaymentMethodNetworkTokensRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListPaymentMethodNetworkTokensRequest$outboundSchema.parse(
        value,
      ),
