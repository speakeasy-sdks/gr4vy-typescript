 ...
 */
export async function getTransactionRefund(
    client$: Gr4vyCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.GetTransactionRefundRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/transactions/{transaction_id}/refunds/{refund_id}")(pathParams$);
