 ...
 */
export async function createNetworkToken(
    client$: Gr4vyCore,
    ...
    >
> {
    const input$: operations.CreateNetworkTokenRequest = {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.CreateNetworkTokenRequest$outboundSchema.parse(value$),
    ...
    const body$ = encodeJSON$("body", payload$.NetworkTokenCreate, { explode: true });
    ...
    const context = {
        operationID: "create_network_token",
        oAuth2Scopes: [],
