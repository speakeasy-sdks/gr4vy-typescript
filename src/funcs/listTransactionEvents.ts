...
export async function listTransactionEvents(
    ...
    Result<
        components.TransactionEventCollection,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ListTransactionEventsRequest$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, components.TransactionEventCollection$inboundSchema),
