...
export async function listMerchantAccounts(
    ...
    >
> {
    const input$: operations.ListMerchantAccountsRequest = {
        cursor: cursor,
        limit: limit,
        search: search,
    };
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ListMerchantAccountsRequest$outboundSchema.parse(value$),
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ListMerchantAccountsResponse$inboundSchema, { key: "Result" }),
    ...
    > => {
        ...
        return () => listMerchantAccounts(client$, nextCursor, limit, search, options);
    };
