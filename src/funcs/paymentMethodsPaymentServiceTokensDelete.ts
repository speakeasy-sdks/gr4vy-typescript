 ...
 */
export function paymentMethodsPaymentServiceTokensDelete(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.DeletePaymentMethodPaymentServiceTokenResponse403DeletePaymentMethodPaymentServiceToken
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DeletePaymentMethodPaymentServiceTokenRequest$outboundSchema
        .parse(value),
