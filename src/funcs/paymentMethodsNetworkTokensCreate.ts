 ...
 */
export async function paymentMethodsNetworkTokensCreate(
  client: Gr4vyCore,
  ...
  >
> {
  const input: operations.CreatePaymentMethodNetworkTokenRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.CreatePaymentMethodNetworkTokenRequest$outboundSchema.parse(
        value,
      ),
