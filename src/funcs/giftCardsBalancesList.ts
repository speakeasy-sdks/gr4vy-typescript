 ...
 */
export function giftCardsBalancesList(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.ListGiftCardBalancesResponse403ListGiftCardBalances
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  const input: operations.ListGiftCardBalancesRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListGiftCardBalancesRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.GiftCardBalanceRequest, {
    explode: true,
  });
  ...
  >(
    ...
    M.jsonErr(
      403,
      errors.ListGiftCardBalancesResponse403ListGiftCardBalances$inboundSchema,
    ),
