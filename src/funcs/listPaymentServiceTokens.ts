 ...
 */
export async function listPaymentServiceTokens(
    client$: Gr4vyCore,
    ...
    >
> {
    const input$: operations.ListPaymentServiceTokensRequest = {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ListPaymentServiceTokensRequest$outboundSchema.parse(value$),
    ...
    const context = {
        operationID: "list_payment_service_tokens",
        oAuth2Scopes: [],
