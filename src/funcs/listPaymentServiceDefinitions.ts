 ...
 * Browse
 */
export async function listPaymentServiceDefinitions(
    client$: Gr4vyCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ListPaymentServiceDefinitionsRequest$outboundSchema.parse(value$),
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ListPaymentServiceDefinitionsResponse$inboundSchema, {
            key: "Result",
        }),
    ...
    > => {
        ...
        return () => listPaymentServiceDefinitions(client$, nextCursor, limit, options);
    };
