...
export function reportExecutionsList(
  ...
  PageIterator<
    Result<
      operations.ListAllReportExecutionsResponse,
      | errors.Error400
      | errors.Error401
      | errors.Error403
      | errors.Error404
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAllReportExecutionsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/report-executions")();
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListAllReportExecutionsResponse$inboundSchema, {
      key: "Result",
    }),
