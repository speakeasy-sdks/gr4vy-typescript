 ...
 */
export function paymentServiceDefinitionsList(
  client: Gr4vyCore,
  ...
  PageIterator<
    Result<
      ...
      | errors.Error400
      | errors.Error401
      | errors.ListPaymentServiceDefinitionsResponse403ListPaymentServiceDefinitions
      | errors.Error404
      | errors.Error405
      | errors.Error409
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListPaymentServiceDefinitionsRequest$outboundSchema.optional()
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.ListPaymentServiceDefinitionsResponse$inboundSchema,
      { key: "Result" },
    ),
