...
export async function refundTransaction(
    ...
    >
> {
    const input$: operations.RefundTransactionRequest = {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.RefundTransactionRequest$outboundSchema.parse(value$),
    ...
    const body$ = encodeJSON$("body", payload$.TransactionRefundCreate, { explode: true });
