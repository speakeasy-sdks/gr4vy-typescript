...
export function buyersCreate(
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.AddBuyerResponse403AddBuyer
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  const input: operations.AddBuyerRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.AddBuyerRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.BuyerCreate, { explode: true });
  ...
  >(
    ...
    M.jsonErr(403, errors.AddBuyerResponse403AddBuyer$inboundSchema),
