...
export function reportsList(
  ...
  PageIterator<
    Result<
      operations.ListReportsResponse,
      | errors.Error400
      | errors.Error401
      | errors.Error403
      | errors.Error404
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListReportsRequest$outboundSchema.optional().parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListReportsResponse$inboundSchema, {
      key: "Result",
    }),
