 ...
 */
export function buyersShippingDetailsCreate(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.AddBuyerShippingDetailsResponse403AddBuyerShippingDetails
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.AddBuyerShippingDetailsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ShippingDetailsCreate, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.ShippingDetails$inboundSchema),
