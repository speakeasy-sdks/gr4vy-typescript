 ...
 * Add
 */
export async function generateApplePayCertificate(
    client$: Gr4vyCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => components.ApplePayCertificateCreate$outboundSchema.parse(value$),
    ...
    const context = {
        operationID: "generate_apple_pay_certificate",
        oAuth2Scopes: [],
