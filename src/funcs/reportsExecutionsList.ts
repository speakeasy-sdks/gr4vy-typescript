 ...
 */
export function reportsExecutionsList(
  client: Gr4vyCore,
  reportId: string,
  ...
  PageIterator<
    Result<
      operations.ListReportExecutionsResponse,
      | errors.Error400
      | errors.Error401
      | errors.Error403
      | errors.Error404
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListReportExecutionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/reports/{report_id}/executions")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListReportExecutionsResponse$inboundSchema, {
      key: "Result",
    }),
