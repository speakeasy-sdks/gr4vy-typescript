 ...
 */
export function digitalWalletsDelete(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.DeleteDigitalWalletResponse403DeleteDigitalWallet
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DeleteDigitalWalletRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      403,
      errors.DeleteDigitalWalletResponse403DeleteDigitalWallet$inboundSchema,
    ),
