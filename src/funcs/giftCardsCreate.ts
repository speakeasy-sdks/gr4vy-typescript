 ...
 */
export function giftCardsCreate(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.CreateGiftCardResponse403CreateGiftCard
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  const input: operations.CreateGiftCardRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.CreateGiftCardRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.GiftCardCreate, { explode: true });
  ...
  >(
    ...
    M.jsonErr(
      403,
      errors.CreateGiftCardResponse403CreateGiftCard$inboundSchema,
    ),
