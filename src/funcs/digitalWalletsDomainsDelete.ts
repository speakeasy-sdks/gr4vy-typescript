 ...
 */
export function digitalWalletsDomainsDelete(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.UnregisterDigitalWalletDomainResponse403UnregisterDigitalWalletDomain
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.UnregisterDigitalWalletDomainRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.DigitalWalletDomain, {
    explode: true,
  });

  const pathParams = {
    digital_wallet_id: encodeSimple(
      "digital_wallet_id",
      payload.digital_wallet_id,
