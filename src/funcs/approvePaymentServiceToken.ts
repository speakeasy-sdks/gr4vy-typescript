 ...
 */
export async function approvePaymentServiceToken(
    client$: Gr4vyCore,
    ...
    >
> {
    const input$: operations.ApprovePaymentServiceTokenRequest = {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.ApprovePaymentServiceTokenRequest$outboundSchema.parse(value$),
    ...
    const context = {
        operationID: "approve_payment_service_token",
        oAuth2Scopes: [],
