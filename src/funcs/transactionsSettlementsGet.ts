 ...
 */
export function transactionsSettlementsGet(
  client: Gr4vyCore,
...
> {
  const input: operations.GetTransactionSettlementRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetTransactionSettlementRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.Settlement$inboundSchema),
