 ...
 */
export function transactionsSettlementsList(
  client: Gr4vyCore,
...
> {
  const input: operations.ListTransactionSettlementsRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListTransactionSettlementsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.Settlements$inboundSchema),
