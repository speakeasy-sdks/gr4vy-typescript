 ...
 */
export function paymentServicesDelete(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.DeletePaymentServiceResponse403DeletePaymentService
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DeletePaymentServiceRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr(
      403,
      errors.DeletePaymentServiceResponse403DeletePaymentService$inboundSchema,
    ),
