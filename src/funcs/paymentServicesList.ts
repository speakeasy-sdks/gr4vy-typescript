 ...
 */
export function paymentServicesList(
  client: Gr4vyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListPaymentServicesRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListPaymentServicesResponse$inboundSchema, {
      key: "Result",
    }),
