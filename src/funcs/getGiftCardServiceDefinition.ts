 ...
 * Get
 */
export async function getGiftCardServiceDefinition(
    client$: Gr4vyCore,
...
> {
    ...
    const path$ = pathToFunc("/gift-card-service-definitions/{gift_card_service_definition_id}")(
        pathParams$
    );
    ...
    const context = {
        operationID: "get_gift_card_service_definition",
        oAuth2Scopes: [],
