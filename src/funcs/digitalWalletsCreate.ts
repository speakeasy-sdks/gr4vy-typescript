 ...
 */
export function digitalWalletsCreate(
  client: Gr4vyCore,
  ...
  Result<
    ...
    | errors.Error400
    | errors.Error401
    | errors.ConfigureDigitalWalletResponse403ConfigureDigitalWallet
    | errors.Error404
    | errors.Error405
    | errors.Error409
...
> {
  const input: operations.ConfigureDigitalWalletRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ConfigureDigitalWalletRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.DigitalWalletCreate, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.DigitalWallet$inboundSchema),
