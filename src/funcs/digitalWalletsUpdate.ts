 ...
 */
export function digitalWalletsUpdate(
  client: Gr4vyCore,
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.UpdateDigitalWalletRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.DigitalWalletUpdate, {
    explode: true,
  });
