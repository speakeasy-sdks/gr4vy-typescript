...
export type ListPaymentServicesResponse = {
    ...
    /**
     * Returns a list of payment services.
     */
    paymentServices?: components.PaymentServices | undefined;
};
...
export namespace ListPaymentServicesResponse$ {
    export type Inbound = {
        ...
        PaymentServices?: components.PaymentServices$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<ListPaymentServicesResponse, z.ZodTypeDef, Inbound> = z
        .object({
            HttpMeta: components.HTTPMetadata$.inboundSchema,
            PaymentServices: components.PaymentServices$.inboundSchema.optional(),
        })
        .transform((v) => {
            return {
                httpMeta: v.HttpMeta,
                ...(v.PaymentServices === undefined
                    ? null
                    : { paymentServices: v.PaymentServices }),
            };
        });

    export type Outbound = {
        HttpMeta: components.HTTPMetadata$.Outbound;
        PaymentServices?: components.PaymentServices$.Outbound | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListPaymentServicesResponse> = z
        .object({
            httpMeta: components.HTTPMetadata$.outboundSchema,
            paymentServices: components.PaymentServices$.outboundSchema.optional(),
        })
        .transform((v) => {
            return {
                HttpMeta: v.httpMeta,
