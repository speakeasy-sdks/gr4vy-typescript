...
export namespace UpdateCurrentUserResponse$ {
    ...
    export const inboundSchema: z.ZodType<UpdateCurrentUserResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpdateCurrentUserResponse> = z
        .object({
