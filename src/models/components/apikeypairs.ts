...
import { APIKeyPair, APIKeyPair$ } from "./apikeypair";
import * as z from "zod";

/**
 * A list of the currently active API key pairs.
 */
export type APIKeyPairs = {
    items?: Array<APIKeyPair> | undefined;
    /**
...
/** @internal */
export namespace APIKeyPairs$ {
    export type Inbound = {
        items?: Array<APIKeyPair$.Inbound> | undefined;
        limit?: number | undefined;
        next_cursor?: string | null | undefined;
        previous_cursor?: string | null | undefined;
    };

    export const inboundSchema: z.ZodType<APIKeyPairs, z.ZodTypeDef, Inbound> = z
        .object({
            items: z.array(APIKeyPair$.inboundSchema).optional(),
    ...
    export type Outbound = {
        items?: Array<APIKeyPair$.Outbound> | undefined;
        limit: number;
        next_cursor?: string | null | undefined;
        previous_cursor?: string | null | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, APIKeyPairs> = z
        .object({
            items: z.array(APIKeyPair$.outboundSchema).optional(),
            limit: z.number().int().default(20),
