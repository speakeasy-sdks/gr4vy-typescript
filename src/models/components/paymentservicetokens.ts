...
import { PaymentServiceToken, PaymentServiceToken$ } from "./paymentservicetoken";
...
export type PaymentServiceTokens = {
     ...
     * A list of payment service tokens.
     */
    items?: Array<PaymentServiceToken> | undefined;
    /**
...
export namespace PaymentServiceTokens$ {
    export type Inbound = {
        items?: Array<PaymentServiceToken$.Inbound> | undefined;
        limit?: number | undefined;
        next_cursor?: string | null | undefined;
        previous_cursor?: string | null | undefined;
    };

    export const inboundSchema: z.ZodType<PaymentServiceTokens, z.ZodTypeDef, Inbound> = z
        .object({
            items: z.array(PaymentServiceToken$.inboundSchema).optional(),
    ...
    export type Outbound = {
        items?: Array<PaymentServiceToken$.Outbound> | undefined;
        limit: number;
        next_cursor?: string | null | undefined;
        previous_cursor?: string | null | undefined;
    };

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PaymentServiceTokens> = z
        .object({
            items: z.array(PaymentServiceToken$.outboundSchema).optional(),
            limit: z.number().int().default(20),
