...
| `sortBy`                                                                                                      | *operations.SortBy*                                                                                           | :heavy_minus_sign:                                                                                            | The field to sort the payment methods by.                                                                     | last_used_at                                                                                                  |
...
| `country`                                                                                                     | *string*                                                                                                      | :heavy_minus_sign:                                                                                            | The country code to filter payment methods by. This only applies to payment methods with a `country` value.   | DE                                                                                                            |
| `currency`                                                                                                    | *string*                                                                                                      | :heavy_minus_sign:                                                                                            | The currency code to filter payment methods by. This only applies to payment methods with a `currency` value. | EUR                                                                                                           |