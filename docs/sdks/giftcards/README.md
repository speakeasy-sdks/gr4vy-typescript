...
async function run() {
  const result = await gr4vy.giftCards.get("356d56e5-fe16-42ae-97ee-8d55d846ae2e", "default");
...
async function run() {
  const res = await giftCardsGet(gr4vy, "356d56e5-fe16-42ae-97ee-8d55d846ae2e", "default");
