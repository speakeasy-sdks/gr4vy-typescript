...
async function run() {
  const result = await gr4vy.transactions.get("b888f774-3e7c-4135-a18c-6b985523c4bc");
...
async function run() {
  const res = await transactionsGet(gr4vy, "b888f774-3e7c-4135-a18c-6b985523c4bc");
...
async function run() {
  ...
  }, "cac402e8-3f44-4782-bac4-283b15a3b3e2");
...
async function run() {
  const result = await gr4vy.transactions.sync("f0897be3-0808-45c9-a63b-509c0142ddd3");
...
async function run() {
  const res = await transactionsSync(gr4vy, "f0897be3-0808-45c9-a63b-509c0142ddd3");
