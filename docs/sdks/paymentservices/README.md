...
async function run() {
  const result = await gr4vy.paymentServices.listPaymentServices(1, "ZXhhbXBsZTE", "card", true);
...
async function run() {
  const result = await gr4vy.paymentServices.newPaymentService({
...
async function run() {
  const result = await gr4vy.paymentServices.getPaymentService("46973e9d-88a7-44a6-abfe-be4ff0134ff4");
...
async function run() {
  const result = await gr4vy.paymentServices.updatePaymentService("46973e9d-88a7-44a6-abfe-be4ff0134ff4", {
    displayName: "Stripe (Main)",
    fields: [
      {
        key: "private_key",
...
async function run() {
  await gr4vy.paymentServices.deletePaymentService("46973e9d-88a7-44a6-abfe-be4ff0134ff4");
...
async function run() {
  const result = await gr4vy.paymentServices.createPaymentServiceSession("46973e9d-88a7-44a6-abfe-be4ff0134ff4", {
    "key": "<value>",
  });
...
async function run() {
  await gr4vy.paymentServices.verifyPaymentService({
    paymentServiceDefinitionId: "stripe-card",
