...
async function run() {
  const result = await gr4vy.transactions.events.list("7099948d-7286-47e4-aad8-b68f7eb44591", "ZXhhbXBsZTE");
...
async function run() {
  const res = await transactionsEventsList(gr4vy, "7099948d-7286-47e4-aad8-b68f7eb44591", "ZXhhbXBsZTE");
